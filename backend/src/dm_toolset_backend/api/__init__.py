...
from dm_toolset_backend.api.inventory import router as inventory_router
from dm_toolset_backend.api.proficiencies import router as proficiencies_router
from dm_toolset_backend.api.weapons import router as weapons_router
from dm_toolset_backend.api.armors import router as armors_router
...
api_router.include_router(proficiencies_router)
api_router.include_router(weapons_router)
api_router.include_router(armors_router)
